...
if(isset($_GET['openid_mode'])&&$_GET['openid_mode']=='id_res'&&isset($_GET['openid_identity'])&&isset($_GET['openid_ext1_value_email']))
{
$openid=explode("=",$_GET['openid_identity']);
$id=explode("@",$_GET['openid_ext1_value_email']);
$id[0].="@google";
