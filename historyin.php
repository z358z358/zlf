...
$(".tablesorter td:nth-child(6)").addClass("right");
...
$(".tablesorter td:nth-child(6)").css("padding-right","5px");
...
?>
	...
	<div class="fullimg absolute" style="z-index:999;height:40px;width:177.5px;margin-left:355px"><a href="historyin.php"><img src="images/userinfo/thin.on.png" border="0"/></a></div>
